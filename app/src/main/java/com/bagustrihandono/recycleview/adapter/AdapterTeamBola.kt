package com.bagustrihandono.recycleview.adapter
...
import com.bagustrihandono.recycleview.databinding.ListItemPemainBinding
import com.bagustrihandono.recycleview.model.Pemain

class AdapterTeamBola(private val context: Context,private val data : List<Pemain>?,private val itemclick : onClickListener) :
